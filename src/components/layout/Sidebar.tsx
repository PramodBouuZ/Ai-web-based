...
const navItems: NavItem[] = [
  ...
  { label: 'Tenant Management', icon: Building2, path: '/tenants', requiredPermission: { module: 'tenants', action: 'manage' } },
      ...
      >
        ...
        <div className="h-16 flex items-center px-4 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0B5ED7] to-[#084298] flex items-center justify-center flex-shrink-0">
                ...
                <li key={item.path}>
                  {collapsed ? (
                    ...
                    >
                      ...
                      {isActive && (
                        <div className="ml-auto w-1.5 h-1.5 rounded-full bg-[#0B5ED7]" />
                      )}
                    </NavLink>
                  )}
                </li>
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-800">
          ...
          >
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#0B5ED7] to-[#084298] flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="absolute -right-3 top-20 w-6 h-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow focus:outline-none focus:ring-2 focus:ring-[#0B5ED7]"
